...
-   响应参数
    ...
    <td class="cellrowborder" valign="top" width="22.62%" headers="mcps1.1.4.1.2 "><p id="p6490369115541"><a name="p6490369115541"></a><a name="p6490369115541"></a>array</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><p id="p20205612201856"><a name="p20205612201856"></a><a name="p20205612201856"></a>扩展接口列表。</p>
    </td>
    </tr>
    </tbody>
    </table>
...
-   extensions参数说明
    ...
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><p id="p64318586171033"><a name="p64318586171033"></a><a name="p64318586171033"></a>最后的更新时间。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><p id="p61224008171033"><a name="p61224008171033"></a><a name="p61224008171033"></a>云硬盘传递的链接。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><p id="p22448926171033"><a name="p22448926171033"></a><a name="p22448926171033"></a>扩展的别名。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><p id="p2055232171033"><a name="p2055232171033"></a><a name="p2055232171033"></a>云硬盘传递的名称。</p>
    </td>
    </tr>
    </tbody>
    </table>
