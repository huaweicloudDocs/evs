# 设置云硬盘启动盘标识<a name="evs_04_2084"></a>
...
-   请求参数
    ...
    <td class="cellrowborder" valign="top" width="48%" headers="mcps1.1.5.1.4 "><p id="p6336250715377"><a name="p6336250715377"></a><a name="p6336250715377"></a>标记设置云硬盘启动盘操作，请参见<a href="#li11686008105423">•os-set_bootable参数说明</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>

-   <a name="li11686008105423"></a>os-set\_bootable参数说明
