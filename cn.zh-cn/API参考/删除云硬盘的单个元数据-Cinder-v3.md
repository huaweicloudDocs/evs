# 删除云硬盘的单个元数据<a name="evs_04_3043"></a>
...
-   响应参数
    ...
    <td class="cellrowborder" valign="top" width="21.17788221177882%" headers="mcps1.1.4.1.2 "><p id="evs_04_2079_p1595262111415"><a name="evs_04_2079_p1595262111415"></a><a name="evs_04_2079_p1595262111415"></a>Object</p>
    </td>
...
-   <a name="evs_04_2079_li0419202382514"></a>error参数说明
    ...
    <p id="evs_04_2079_evs_04_2013_p54787218103019"><a name="evs_04_2079_evs_04_2013_p54787218103019"></a><a name="evs_04_2079_evs_04_2013_p54787218103019"></a>错误码和其对应的含义请参考<a href="错误码.md">错误码</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
