# 查询单个云硬盘详情<a name="ZH-CN_TOPIC_0102754044"></a>
...
-   响应参数
    ...
    <tbody><tr id="zh-cn_topic_0020235170_row444782011610"><td class="cellrowborder" valign="top" width="21.43%" headers="mcps1.1.4.1.1 "><p id="zh-cn_topic_0020235170_p459645601610"><a name="zh-cn_topic_0020235170_p459645601610"></a><a name="zh-cn_topic_0020235170_p459645601610"></a>volume</p>
    </td>
    <td class="cellrowborder" valign="top" width="21.43%" headers="mcps1.1.4.1.2 "><p id="zh-cn_topic_0020235170_p321418421610"><a name="zh-cn_topic_0020235170_p321418421610"></a><a name="zh-cn_topic_0020235170_p321418421610"></a>map</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0020235170_p265791971610"><a name="zh-cn_topic_0020235170_p265791971610"></a><a name="zh-cn_topic_0020235170_p265791971610"></a>查询请求返回的云硬盘。</p>
    </td>
    </tr>
    <tr id="zh-cn_topic_0020235170_row44077962142557"><td class="cellrowborder" valign="top" width="21.43%" headers="mcps1.1.4.1.1 "><p id="zh-cn_topic_0020235170_p13545137142557"><a name="zh-cn_topic_0020235170_p13545137142557"></a><a name="zh-cn_topic_0020235170_p13545137142557"></a>id</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0020235170_p9255075142557"><a name="zh-cn_topic_0020235170_p9255075142557"></a><a name="zh-cn_topic_0020235170_p9255075142557"></a>云硬盘uuid。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0020235170_p27456944142557"><a name="zh-cn_topic_0020235170_p27456944142557"></a><a name="zh-cn_topic_0020235170_p27456944142557"></a>云硬盘uri自描述信息。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="21.43%" headers="mcps1.1.4.1.2 "><p id="zh-cn_topic_0020235170_p2054104142557"><a name="zh-cn_topic_0020235170_p2054104142557"></a><a name="zh-cn_topic_0020235170_p2054104142557"></a>string</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0020235170_p30604994142557"><a name="zh-cn_topic_0020235170_p30604994142557"></a><a name="zh-cn_topic_0020235170_p30604994142557"></a>云硬盘的挂载信息。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0020235170_p54429968142557"><a name="zh-cn_topic_0020235170_p54429968142557"></a><a name="zh-cn_topic_0020235170_p54429968142557"></a>快照ID，如果是从快照创建，则有值。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0020235170_p5075579142557"><a name="zh-cn_topic_0020235170_p5075579142557"></a><a name="zh-cn_topic_0020235170_p5075579142557"></a>云硬盘所属的租户ID。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="21.43%" headers="mcps1.1.4.1.2 "><p id="zh-cn_topic_0020235170_p66830090142557"><a name="zh-cn_topic_0020235170_p66830090142557"></a><a name="zh-cn_topic_0020235170_p66830090142557"></a>map&lt;string, string&gt;</p>
    </td>
    ...
    <div class="note" id="zh-cn_topic_0020235170_note13108526174911"><a name="zh-cn_topic_0020235170_note13108526174911"></a><a name="zh-cn_topic_0020235170_note13108526174911"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="zh-cn_topic_0020235170_zh-cn_topic_0020235147_p1888154732118"><a name="zh-cn_topic_0020235170_zh-cn_topic_0020235147_p1888154732118"></a><a name="zh-cn_topic_0020235170_zh-cn_topic_0020235147_p1888154732118"></a>关于“volume_image_metadata”字段的详细说明，具体请参见“镜像服务API参考”中的“查询镜像详情（OpenStack原生）”章节。</p>
    </div></div>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0020235170_p3501903142557"><a name="zh-cn_topic_0020235170_p3501903142557"></a><a name="zh-cn_topic_0020235170_p3501903142557"></a>云硬盘创建时间。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="21.43%" headers="mcps1.1.4.1.2 "><p id="zh-cn_topic_0020235170_p13767590142557"><a name="zh-cn_topic_0020235170_p13767590142557"></a><a name="zh-cn_topic_0020235170_p13767590142557"></a>int</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0020235170_p628596142557"><a name="zh-cn_topic_0020235170_p628596142557"></a><a name="zh-cn_topic_0020235170_p628596142557"></a>云硬盘大小。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0020235170_p27087696142557"><a name="zh-cn_topic_0020235170_p27087696142557"></a><a name="zh-cn_topic_0020235170_p27087696142557"></a>是否为可启动云硬盘。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="21.43%" headers="mcps1.1.4.1.2 "><p id="zh-cn_topic_0020235170_p28729858142557"><a name="zh-cn_topic_0020235170_p28729858142557"></a><a name="zh-cn_topic_0020235170_p28729858142557"></a>map&lt;string, string&gt;</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0020235170_p2976878614485"><a name="zh-cn_topic_0020235170_p2976878614485"></a><a name="zh-cn_topic_0020235170_p2976878614485"></a>云硬盘的元数据。</p>
    ...
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0020235170_p33074440142557"><a name="zh-cn_topic_0020235170_p33074440142557"></a><a name="zh-cn_topic_0020235170_p33074440142557"></a>云硬盘所在的主机。</p>
    </td>
    </tr>
    <tr id="zh-cn_topic_0020235170_row35655683142957"><td class="cellrowborder" valign="top" width="21.43%" headers="mcps1.1.4.1.1 "><p id="zh-cn_topic_0020235170_p48426632153922"><a name="zh-cn_topic_0020235170_p48426632153922"></a><a name="zh-cn_topic_0020235170_p48426632153922"></a>encrypted</p>
    </td>
    <td class="cellrowborder" valign="top" width="21.43%" headers="mcps1.1.4.1.2 "><p id="zh-cn_topic_0020235170_p30243153153922"><a name="zh-cn_topic_0020235170_p30243153153922"></a><a name="zh-cn_topic_0020235170_p30243153153922"></a>Boolean</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0020235170_p51528552153922"><a name="zh-cn_topic_0020235170_p51528552153922"></a><a name="zh-cn_topic_0020235170_p51528552153922"></a>是否为加密云硬盘。</p>
    </td>
    </tr>
    ...
    <tr id="zh-cn_topic_0020235170_row6226231314391"><td class="cellrowborder" valign="top" width="21.43%" headers="mcps1.1.4.1.1 "><p id="zh-cn_topic_0020235170_p1008260514391"><a name="zh-cn_topic_0020235170_p1008260514391"></a><a name="zh-cn_topic_0020235170_p1008260514391"></a>os-volume-replication:extended_status</p>
    </td>
    ...
    <tr id="zh-cn_topic_0020235170_row29234512142557"><td class="cellrowborder" valign="top" width="21.43%" headers="mcps1.1.4.1.1 "><p id="zh-cn_topic_0020235170_p19185291142557"><a name="zh-cn_topic_0020235170_p19185291142557"></a><a name="zh-cn_topic_0020235170_p19185291142557"></a>message</p>
    </td>
    <td class="cellrowborder" valign="top" width="21.43%" headers="mcps1.1.4.1.2 "><p id="zh-cn_topic_0020235170_p10504751142557"><a name="zh-cn_topic_0020235170_p10504751142557"></a><a name="zh-cn_topic_0020235170_p10504751142557"></a>string</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0020235170_p868303142557"><a name="zh-cn_topic_0020235170_p868303142557"></a><a name="zh-cn_topic_0020235170_p868303142557"></a>出现错误时，返回的错误消息。</p>
    </td>
    </tr>
    <tr id="zh-cn_topic_0020235170_row7814730142557"><td class="cellrowborder" valign="top" width="21.43%" headers="mcps1.1.4.1.1 "><p id="zh-cn_topic_0020235170_p29013374142557"><a name="zh-cn_topic_0020235170_p29013374142557"></a><a name="zh-cn_topic_0020235170_p29013374142557"></a>code</p>
    </td>
    <td class="cellrowborder" valign="top" width="21.43%" headers="mcps1.1.4.1.2 "><p id="zh-cn_topic_0020235170_p1273087142557"><a name="zh-cn_topic_0020235170_p1273087142557"></a><a name="zh-cn_topic_0020235170_p1273087142557"></a>string</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0020235170_p31225093142557"><a name="zh-cn_topic_0020235170_p31225093142557"></a><a name="zh-cn_topic_0020235170_p31225093142557"></a>出现错误时，返回的错误码。</p>
    <p id="zh-cn_topic_0020235170_p12590388142557"><a name="zh-cn_topic_0020235170_p12590388142557"></a><a name="zh-cn_topic_0020235170_p12590388142557"></a>错误码和其对应的含义请参考<a href="错误码说明.md">错误码说明</a>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0020235170_p36664377115045"><a name="zh-cn_topic_0020235170_p36664377115045"></a><a name="zh-cn_topic_0020235170_p36664377115045"></a>创建共享云硬盘的信息。</p>
    </td>
    </tr>
    </tbody>
    </table>
...
-   attachments参数说明
    ...
    <tbody><tr id="zh-cn_topic_0020235170_row7439020111147"><td class="cellrowborder" valign="top" width="21.43%" headers="mcps1.1.4.1.1 "><p id="zh-cn_topic_0020235170_p65689739111147"><a name="zh-cn_topic_0020235170_p65689739111147"></a><a name="zh-cn_topic_0020235170_p65689739111147"></a>server_id</p>
    </td>
...
-   metadata参数说明
    ...
    <tr id="zh-cn_topic_0020235170_zh-cn_topic_0102756196_row16478023164611"><td class="cellrowborder" valign="top" width="20.24%" headers="mcps1.1.4.1.1 "><p id="zh-cn_topic_0020235170_zh-cn_topic_0102756196_p15479323204615"><a name="zh-cn_topic_0020235170_zh-cn_topic_0102756196_p15479323204615"></a><a name="zh-cn_topic_0020235170_zh-cn_topic_0102756196_p15479323204615"></a>readonly</p>
    </td>
    <td class="cellrowborder" valign="top" width="22.62%" headers="mcps1.1.4.1.2 "><p id="zh-cn_topic_0020235170_zh-cn_topic_0102756196_p134792232467"><a name="zh-cn_topic_0020235170_zh-cn_topic_0102756196_p134792232467"></a><a name="zh-cn_topic_0020235170_zh-cn_topic_0102756196_p134792232467"></a>string</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><div class="p" id="zh-cn_topic_0020235170_zh-cn_topic_0102756196_p3479112318462"><a name="zh-cn_topic_0020235170_zh-cn_topic_0102756196_p3479112318462"></a><a name="zh-cn_topic_0020235170_zh-cn_topic_0102756196_p3479112318462"></a>是否为只读模式云硬盘。<a name="zh-cn_topic_0020235170_zh-cn_topic_0102756196_ul11587123175320"></a><a name="zh-cn_topic_0020235170_zh-cn_topic_0102756196_ul11587123175320"></a><ul id="zh-cn_topic_0020235170_zh-cn_topic_0102756196_ul11587123175320"><li>True表示云硬盘仅支持可读模式。</li><li>False表示云硬盘支持读写模式。</li></ul>
    </div>
    </td>
    </tr>
    <tr id="zh-cn_topic_0020235170_zh-cn_topic_0102756196_row347911235465"><td class="cellrowborder" valign="top" width="20.24%" headers="mcps1.1.4.1.1 "><p id="zh-cn_topic_0020235170_zh-cn_topic_0102756196_p18479142364612"><a name="zh-cn_topic_0020235170_zh-cn_topic_0102756196_p18479142364612"></a><a name="zh-cn_topic_0020235170_zh-cn_topic_0102756196_p18479142364612"></a>attached_mode</p>
    </td>
    <td class="cellrowborder" valign="top" width="22.62%" headers="mcps1.1.4.1.2 "><p id="zh-cn_topic_0020235170_zh-cn_topic_0102756196_p1547917231465"><a name="zh-cn_topic_0020235170_zh-cn_topic_0102756196_p1547917231465"></a><a name="zh-cn_topic_0020235170_zh-cn_topic_0102756196_p1547917231465"></a>string</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><div class="p" id="zh-cn_topic_0020235170_zh-cn_topic_0102756196_p11479102334617"><a name="zh-cn_topic_0020235170_zh-cn_topic_0102756196_p11479102334617"></a><a name="zh-cn_topic_0020235170_zh-cn_topic_0102756196_p11479102334617"></a>只有当云硬盘已挂载至云服务器时，才有该字段，表示云硬盘的使用模式。<a name="zh-cn_topic_0020235170_zh-cn_topic_0102756196_ul17760125635418"></a><a name="zh-cn_topic_0020235170_zh-cn_topic_0102756196_ul17760125635418"></a><ul id="zh-cn_topic_0020235170_zh-cn_topic_0102756196_ul17760125635418"><li>ro表示只读模式。</li><li>rw表示读写模式。</li></ul>
    </div>
    </td>
    </tr>
    </tbody>
