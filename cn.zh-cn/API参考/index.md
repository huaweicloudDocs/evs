...
-   [OpenStack Cinder API v3]
    ...
    -   [云硬盘Actions]
        ...
        -   [设置云硬盘启动盘标识](设置云硬盘启动盘标识-Cinder-v3.md)
        -   [设置云硬盘只读标识](设置云硬盘只读标识-Cinder-v3.md)
...
-   [OpenStack Cinder API v2]
    ...
    -   [云硬盘过户]
        -   [创建云硬盘过户](创建云硬盘过户-Cinder-v2.md)
        -   [接受云硬盘过户](接受云硬盘过户-Cinder-v2.md)
        -   [删除云硬盘过户](删除云硬盘过户-Cinder-v2.md)
        -   [查询单个云硬盘过户记录详情](查询单个云硬盘过户记录详情-Cinder-v2.md)
        -   [查询云硬盘过户记录列表概要](查询云硬盘过户记录列表概要-Cinder-v2.md)
        -   [查询云硬盘过户记录列表详情](查询云硬盘过户记录列表详情-Cinder-v2.md)
