...
-   请求参数
    ...
    <td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.5.1.2 "><p id="p10880325112814"><a name="p10880325112814"></a><a name="p10880325112814"></a>map&lt;string, string&gt;</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="48%" headers="mcps1.1.5.1.4 "><p id="p49093903112814"><a name="p49093903112814"></a><a name="p49093903112814"></a>待添加的元数据信息。</p>
    </td>
    </tr>
    </tbody>
    </table>
