...
-   参数说明
    ...
    <p id="zh-cn_topic_0102754840_p55811451337"><a name="zh-cn_topic_0102754840_p55811451337"></a><a name="zh-cn_topic_0102754840_p55811451337"></a>获取方法请参见<a href="获取项目ID.md">获取项目ID</a>。</p>
    </td>
    </tr>
...
-   响应参数
    ...
    <a name="zh-cn_topic_0102754840_table10924124020519"></a>
    <table><thead align="left"><tr id="zh-cn_topic_0102754840_row11924194015519"><th class="cellrowborder" valign="top" width="18.82%" id="mcps1.1.4.1.1"><p id="zh-cn_topic_0102754840_p1925340155113"><a name="zh-cn_topic_0102754840_p1925340155113"></a><a name="zh-cn_topic_0102754840_p1925340155113"></a>参数</p>
    </th>
    <th class="cellrowborder" valign="top" width="23.580000000000002%" id="mcps1.1.4.1.2"><p id="zh-cn_topic_0102754840_p13925440205111"><a name="zh-cn_topic_0102754840_p13925440205111"></a><a name="zh-cn_topic_0102754840_p13925440205111"></a>参数类型</p>
    </th>
    <th class="cellrowborder" valign="top" width="57.599999999999994%" id="mcps1.1.4.1.3"><p id="zh-cn_topic_0102754840_p99250405513"><a name="zh-cn_topic_0102754840_p99250405513"></a><a name="zh-cn_topic_0102754840_p99250405513"></a>描述</p>
    </th>
    </tr>
    </thead>
    <tbody><tr id="zh-cn_topic_0102754840_row159251409514"><td class="cellrowborder" valign="top" width="18.82%" headers="mcps1.1.4.1.1 "><p id="zh-cn_topic_0102754840_p1292513408516"><a name="zh-cn_topic_0102754840_p1292513408516"></a><a name="zh-cn_topic_0102754840_p1292513408516"></a>volume</p>
    </td>
    <td class="cellrowborder" valign="top" width="23.580000000000002%" headers="mcps1.1.4.1.2 "><p id="zh-cn_topic_0102754840_p392564017518"><a name="zh-cn_topic_0102754840_p392564017518"></a><a name="zh-cn_topic_0102754840_p392564017518"></a>Object</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0102754840_p16925134045115"><a name="zh-cn_topic_0102754840_p16925134045115"></a><a name="zh-cn_topic_0102754840_p16925134045115"></a>查询请求返回的云硬盘，请参见<a href="#zh-cn_topic_0102754840_li3451542201439">•volume参数说明</a>。</p>
    </td>
    </tr>
    <tr id="zh-cn_topic_0102754840_row143812361506"><td class="cellrowborder" valign="top" width="18.82%" headers="mcps1.1.4.1.1 "><p id="zh-cn_topic_0102754840_p129522216412"><a name="zh-cn_topic_0102754840_p129522216412"></a><a name="zh-cn_topic_0102754840_p129522216412"></a>error</p>
    </td>
    <td class="cellrowborder" valign="top" width="23.580000000000002%" headers="mcps1.1.4.1.2 "><p id="zh-cn_topic_0102754840_p1595262111415"><a name="zh-cn_topic_0102754840_p1595262111415"></a><a name="zh-cn_topic_0102754840_p1595262111415"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0102754840_p109527215417"><a name="zh-cn_topic_0102754840_p109527215417"></a><a name="zh-cn_topic_0102754840_p109527215417"></a>出现错误时，返回的错误信息，具体请参见<a href="#zh-cn_topic_0102754840_li0419202382514"> error参数说明</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>

-   <a name="zh-cn_topic_0102754840_li3451542201439"></a>volume参数说明
    ...
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0102754840_p9255075142557"><a name="zh-cn_topic_0102754840_p9255075142557"></a><a name="zh-cn_topic_0102754840_p9255075142557"></a><span id="zh-cn_topic_0102754840_text193761052172315"><a name="zh-cn_topic_0102754840_text193761052172315"></a><a name="zh-cn_topic_0102754840_text193761052172315"></a>云硬盘的ID。</span></p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0102754840_p27456944142557"><a name="zh-cn_topic_0102754840_p27456944142557"></a><a name="zh-cn_topic_0102754840_p27456944142557"></a>云硬盘URI自描述信息，请参见<a href="#zh-cn_topic_0102754840_li4929184617138">•links参数说明</a>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0102754840_p30604994142557"><a name="zh-cn_topic_0102754840_p30604994142557"></a><a name="zh-cn_topic_0102754840_p30604994142557"></a>云硬盘的挂载信息，请参见<a href="#zh-cn_topic_0102754840_li4186567617138">•attachments参数说明</a>。</p>
    </td>
    </tr>
    ...
    <p id="zh-cn_topic_0102754840_p102771156662"><a name="zh-cn_topic_0102754840_p102771156662"></a><a name="zh-cn_topic_0102754840_p102771156662"></a><span id="zh-cn_topic_0102754840_text88578719717"><a name="zh-cn_topic_0102754840_text88578719717"></a><a name="zh-cn_topic_0102754840_text88578719717"></a>当前云硬盘服务不支持该字段。</span></p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0102754840_p5075579142557"><a name="zh-cn_topic_0102754840_p5075579142557"></a><a name="zh-cn_topic_0102754840_p5075579142557"></a>云硬盘所属的租户ID。<span id="zh-cn_topic_0102754840_text19941457165313"><a name="zh-cn_topic_0102754840_text19941457165313"></a><a name="zh-cn_topic_0102754840_text19941457165313"></a>租户ID就是项目ID。</span></p>
    </td>
    </tr>
    ...
    <p id="zh-cn_topic_0102754840_p1834613217531"><a name="zh-cn_topic_0102754840_p1834613217531"></a><a name="zh-cn_topic_0102754840_p1834613217531"></a><span id="zh-cn_topic_0102754840_text153631054195313"><a name="zh-cn_topic_0102754840_text153631054195313"></a><a name="zh-cn_topic_0102754840_text153631054195313"></a>时间格式：UTC YYYY-MM-DDTHH:MM:SS.XXXXXX</span></p>
    </td>
    </tr>
    ...
    <div class="p" id="zh-cn_topic_0102754840_zh-cn_topic_0044524833_p112762317377"><a name="zh-cn_topic_0102754840_zh-cn_topic_0044524833_p112762317377"></a><a name="zh-cn_topic_0102754840_zh-cn_topic_0044524833_p112762317377"></a>目前支持“SSD”，“SAS”和“SATA”三种。<a name="zh-cn_topic_0102754840_zh-cn_topic_0044524833_zh-cn_topic_0044524833_zh-cn_topic_0058762427_ul4378238815463"></a><a name="zh-cn_topic_0102754840_zh-cn_topic_0044524833_zh-cn_topic_0044524833_zh-cn_topic_0058762427_ul4378238815463"></a><ul id="zh-cn_topic_0102754840_zh-cn_topic_0044524833_zh-cn_topic_0044524833_zh-cn_topic_0058762427_ul4378238815463"><li>“SSD”为超高IO云硬盘</li><li>“SAS”为高IO云硬盘</li><li>“SATA”为普通IO云硬盘</li></ul>
    </div>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><div class="p" id="zh-cn_topic_0102754840_zh-cn_topic_0098680634_p8780414125315"><a name="zh-cn_topic_0102754840_zh-cn_topic_0098680634_p8780414125315"></a><a name="zh-cn_topic_0102754840_zh-cn_topic_0098680634_p8780414125315"></a>是否为启动云硬盘。<a name="zh-cn_topic_0102754840_ul185931714111"></a><a name="zh-cn_topic_0102754840_ul185931714111"></a><ul id="zh-cn_topic_0102754840_ul185931714111"><li>true：表示为启动云硬盘。</li><li>false：表示为非启动云硬盘。</li></ul>
    </div>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0102754840_p2976878614485"><a name="zh-cn_topic_0102754840_p2976878614485"></a><a name="zh-cn_topic_0102754840_p2976878614485"></a>云硬盘的元数据，请参见<a href="#zh-cn_topic_0102754840_li29114110314">•metadata参数说明</a>。</p>
    ...
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0102754840_p33074440142557"><a name="zh-cn_topic_0102754840_p33074440142557"></a><a name="zh-cn_topic_0102754840_p33074440142557"></a><span id="zh-cn_topic_0102754840_text203605127103"><a name="zh-cn_topic_0102754840_text203605127103"></a><a name="zh-cn_topic_0102754840_text203605127103"></a>预留属性。</span></p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><div class="p" id="zh-cn_topic_0102754840_zh-cn_topic_0098680634_p4781191416535"><a name="zh-cn_topic_0102754840_zh-cn_topic_0098680634_p4781191416535"></a><a name="zh-cn_topic_0102754840_zh-cn_topic_0098680634_p4781191416535"></a>是否为共享云硬盘。<a name="zh-cn_topic_0102754840_ul161621719119"></a><a name="zh-cn_topic_0102754840_ul161621719119"></a><ul id="zh-cn_topic_0102754840_ul161621719119"><li>true：表示为共享云硬盘。</li><li>false：表示为非共享云硬盘。</li></ul>
    </div>
    </td>
    </tr>
...
-   <a name="zh-cn_topic_0102754840_li4929184617138"></a>links参数说明
...
-   <a name="zh-cn_topic_0102754840_li4186567617138"></a>attachments参数说明
...
-   <a name="zh-cn_topic_0102754840_li29114110314"></a>metadata参数说明
...
-   <a name="zh-cn_topic_0102754840_li0419202382514"></a>error参数说明

    <a name="zh-cn_topic_0102754840_zh-cn_topic_0020235144_table15441099103019"></a>
    <table><thead align="left"><tr id="zh-cn_topic_0102754840_zh-cn_topic_0020235144_row54094047103019"><th class="cellrowborder" valign="top" width="21.17788221177882%" id="mcps1.1.4.1.1"><p id="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p19541716103019"><a name="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p19541716103019"></a><a name="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p19541716103019"></a>参数</p>
    </th>
    <th class="cellrowborder" valign="top" width="21.17788221177882%" id="mcps1.1.4.1.2"><p id="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p39375186103019"><a name="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p39375186103019"></a><a name="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p39375186103019"></a>参数类型</p>
    </th>
    <th class="cellrowborder" valign="top" width="57.64423557644236%" id="mcps1.1.4.1.3"><p id="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p38578950103019"><a name="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p38578950103019"></a><a name="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p38578950103019"></a>描述</p>
    </th>
    </tr>
    </thead>
    <tbody><tr id="zh-cn_topic_0102754840_zh-cn_topic_0020235144_row59401790103019"><td class="cellrowborder" valign="top" width="21.17788221177882%" headers="mcps1.1.4.1.1 "><p id="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p46815658103019"><a name="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p46815658103019"></a><a name="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p46815658103019"></a>message</p>
    </td>
    <td class="cellrowborder" valign="top" width="21.17788221177882%" headers="mcps1.1.4.1.2 "><p id="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p33971979103019"><a name="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p33971979103019"></a><a name="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p33971979103019"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.64423557644236%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p21623243103019"><a name="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p21623243103019"></a><a name="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p21623243103019"></a>出现错误时，返回的错误消息。</p>
    </td>
    </tr>
    <tr id="zh-cn_topic_0102754840_zh-cn_topic_0020235144_row60391466103019"><td class="cellrowborder" valign="top" width="21.17788221177882%" headers="mcps1.1.4.1.1 "><p id="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p59870541103019"><a name="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p59870541103019"></a><a name="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p59870541103019"></a>code</p>
    </td>
    <td class="cellrowborder" valign="top" width="21.17788221177882%" headers="mcps1.1.4.1.2 "><p id="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p17675690103019"><a name="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p17675690103019"></a><a name="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p17675690103019"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.64423557644236%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p6087468103019"><a name="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p6087468103019"></a><a name="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p6087468103019"></a>出现错误时，返回的错误码。</p>
    <p id="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p54787218103019"><a name="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p54787218103019"></a><a name="zh-cn_topic_0102754840_zh-cn_topic_0020235144_p54787218103019"></a>错误码和其对应的含义请参考<a href="错误码说明.md">错误码说明</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
