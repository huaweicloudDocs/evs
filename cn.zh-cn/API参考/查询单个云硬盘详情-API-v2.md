# 查询单个云硬盘详情<a name="ZH-CN_TOPIC_0102754840"></a>
...
-   响应参数
    ...
    <tbody><tr id="row444782011610"><td class="cellrowborder" valign="top" width="18.82%" headers="mcps1.1.4.1.1 "><p id="p459645601610"><a name="p459645601610"></a><a name="p459645601610"></a>volume</p>
    </td>
    <td class="cellrowborder" valign="top" width="23.580000000000002%" headers="mcps1.1.4.1.2 "><p id="p321418421610"><a name="p321418421610"></a><a name="p321418421610"></a>map</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><p id="p265791971610"><a name="p265791971610"></a><a name="p265791971610"></a>查询请求返回的云硬盘。</p>
    </td>
    </tr>
    <tr id="row44077962142557"><td class="cellrowborder" valign="top" width="18.82%" headers="mcps1.1.4.1.1 "><p id="p13545137142557"><a name="p13545137142557"></a><a name="p13545137142557"></a>id</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><p id="p9255075142557"><a name="p9255075142557"></a><a name="p9255075142557"></a>云硬盘uuid。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="23.580000000000002%" headers="mcps1.1.4.1.2 "><p id="p35486679142557"><a name="p35486679142557"></a><a name="p35486679142557"></a>list&lt;map&lt;string, string&gt;&gt;</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><p id="p27456944142557"><a name="p27456944142557"></a><a name="p27456944142557"></a>云硬盘uri自描述信息。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="23.580000000000002%" headers="mcps1.1.4.1.2 "><p id="p2582234142557"><a name="p2582234142557"></a><a name="p2582234142557"></a>list&lt;map&lt;string, string&gt;&gt;</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><p id="p30604994142557"><a name="p30604994142557"></a><a name="p30604994142557"></a>云硬盘的挂载信息。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><p id="p5075579142557"><a name="p5075579142557"></a><a name="p5075579142557"></a>云硬盘所属的租户ID。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="23.580000000000002%" headers="mcps1.1.4.1.2 "><p id="p66830090142557"><a name="p66830090142557"></a><a name="p66830090142557"></a>map&lt;string, string&gt;</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="23.580000000000002%" headers="mcps1.1.4.1.2 "><p id="p13767590142557"><a name="p13767590142557"></a><a name="p13767590142557"></a>int</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><p id="p628596142557"><a name="p628596142557"></a><a name="p628596142557"></a>云硬盘大小。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><p id="p27087696142557"><a name="p27087696142557"></a><a name="p27087696142557"></a>是否为可启动云硬盘。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="23.580000000000002%" headers="mcps1.1.4.1.2 "><p id="p28729858142557"><a name="p28729858142557"></a><a name="p28729858142557"></a>map&lt;string, string&gt;</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><p id="p2976878614485"><a name="p2976878614485"></a><a name="p2976878614485"></a>云硬盘的元数据。</p>
    ...
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><p id="p33074440142557"><a name="p33074440142557"></a><a name="p33074440142557"></a>云硬盘所在的主机。</p>
    </td>
    </tr>
    <tr id="row35655683142957"><td class="cellrowborder" valign="top" width="18.82%" headers="mcps1.1.4.1.1 "><p id="p48426632153922"><a name="p48426632153922"></a><a name="p48426632153922"></a>encrypted</p>
    </td>
    <td class="cellrowborder" valign="top" width="23.580000000000002%" headers="mcps1.1.4.1.2 "><p id="p30243153153922"><a name="p30243153153922"></a><a name="p30243153153922"></a>Boolean</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><p id="p51528552153922"><a name="p51528552153922"></a><a name="p51528552153922"></a>是否为加密云硬盘。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="23.580000000000002%" headers="mcps1.1.4.1.2 "><p id="p48108796144650"><a name="p48108796144650"></a><a name="p48108796144650"></a>boolean</p>
    </td>
    ...
    <tr id="row29234512142557"><td class="cellrowborder" valign="top" width="18.82%" headers="mcps1.1.4.1.1 "><p id="p19185291142557"><a name="p19185291142557"></a><a name="p19185291142557"></a>message</p>
    </td>
    <td class="cellrowborder" valign="top" width="23.580000000000002%" headers="mcps1.1.4.1.2 "><p id="p10504751142557"><a name="p10504751142557"></a><a name="p10504751142557"></a>string</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><p id="p868303142557"><a name="p868303142557"></a><a name="p868303142557"></a>出现错误时，返回的错误消息。</p>
    </td>
    </tr>
    <tr id="row7814730142557"><td class="cellrowborder" valign="top" width="18.82%" headers="mcps1.1.4.1.1 "><p id="p29013374142557"><a name="p29013374142557"></a><a name="p29013374142557"></a>code</p>
    </td>
    <td class="cellrowborder" valign="top" width="23.580000000000002%" headers="mcps1.1.4.1.2 "><p id="p1273087142557"><a name="p1273087142557"></a><a name="p1273087142557"></a>string</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><p id="p31225093142557"><a name="p31225093142557"></a><a name="p31225093142557"></a>出现错误时，返回的错误码。</p>
    ...
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><p id="p36664377115045"><a name="p36664377115045"></a><a name="p36664377115045"></a>创建共享云硬盘的信息。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><p id="p1781171475316"><a name="p1781171475316"></a><a name="p1781171475316"></a>云硬盘所属的专属存储池的名称。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="23.580000000000002%" headers="mcps1.1.4.1.2 "><p id="p1198854414439"><a name="p1198854414439"></a><a name="p1198854414439"></a>map&lt;string,string&gt;</p>
    </td>
    ...
    <p id="p898894418432"><a name="p898894418432"></a><a name="p898894418432"></a>如果云硬盘有标签，则会有字段，否则该字段为空。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.1.4.1.3 "><p id="p35013964916"><a name="p35013964916"></a><a name="p35013964916"></a>云硬盘上绑定的企业项目ID。</p>
