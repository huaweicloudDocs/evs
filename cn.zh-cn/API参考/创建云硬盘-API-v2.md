...
本接口兼容“[创建云硬盘（废弃）](创建云硬盘（废弃）-API-v2.md)”接口的功能，同时合入新功能，支持创建包周期的云硬盘。支持企业项目授权功能。
...
## 调试<a name="section11620121022913"></a>

您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=EVS&api=CreateVolume)中直接运行调试该接口。
...
-   请求参数
    ...
    <tr id="row55591146988"><td class="cellrowborder" valign="top" width="17.07%" headers="mcps1.1.5.1.1 "><p id="p1955912461381"><a name="p1955912461381"></a><a name="p1955912461381"></a>OS-SCH-HNT:scheduler_hints</p>
    </td>
    <td class="cellrowborder" valign="top" width="17.93%" headers="mcps1.1.5.1.2 "><p id="p355911461687"><a name="p355911461687"></a><a name="p355911461687"></a>Object</p>
    </td>
    <td class="cellrowborder" valign="top" width="16%" headers="mcps1.1.5.1.3 "><p id="p355918461280"><a name="p355918461280"></a><a name="p355918461280"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="49%" headers="mcps1.1.5.1.4 "><p id="p55592469816"><a name="p55592469816"></a><a name="p55592469816"></a>创建云硬盘的调度参数。请参见<a href="#li16166115891018">•OS-SCH-HNT:scheduler_hi...</a>。</p>
    </td>
    </tr>
    <tr id="row1829514714203"><td class="cellrowborder" valign="top" width="17.07%" headers="mcps1.1.5.1.1 "><p id="p313813972019"><a name="p313813972019"></a><a name="p313813972019"></a>server_id</p>
    </td>
    <td class="cellrowborder" valign="top" width="17.93%" headers="mcps1.1.5.1.2 "><p id="p613816915204"><a name="p613816915204"></a><a name="p613816915204"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="16%" headers="mcps1.1.5.1.3 "><p id="p913811952012"><a name="p913811952012"></a><a name="p913811952012"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="49%" headers="mcps1.1.5.1.4 "><p id="p13138199202012"><a name="p13138199202012"></a><a name="p13138199202012"></a>创建云硬盘并挂载到目标虚拟机。</p>
    </td>
    </tr>
    </tbody>
    </table>
...
-   <a name="li10966323"></a>volume参数说明
    ...
    <div class="note" id="evs_04_2013_note4897195216919"><a name="evs_04_2013_note4897195216919"></a><a name="evs_04_2013_note4897195216919"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p1678892316122"><a name="p1678892316122"></a><a name="p1678892316122"></a>获取备份ID的方法：请参见<a href="https://support.huaweicloud.com/api-cbr/ListBackups.html" target="_blank" rel="noopener noreferrer">查询所有备份</a>。</p>
    </div></div>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="15.151515151515152%" headers="mcps1.1.5.1.3 "><p id="evs_04_2013_p50053294"><a name="evs_04_2013_p50053294"></a><a name="evs_04_2013_p50053294"></a>是</p>
    </td>
    ...
    <div class="p" id="p16231185019372"><a name="p16231185019372"></a><a name="p16231185019372"></a>目前支持“SSD”，“GPSSD”和“SAS”三种。<a name="ul169651733203316"></a><a name="ul169651733203316"></a><ul id="ul169651733203316"><li>“SSD”为超高IO云硬盘</li><li>“GPSSD”为通用型SSD云硬盘</li><li>“SAS”为高IO云硬盘</li></ul>
    </div>
    ...
    <div class="note" id="note1448014325360"><a name="note1448014325360"></a><a name="note1448014325360"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="evs_04_2013_p1600173216137"><a name="evs_04_2013_p1600173216137"></a><a name="evs_04_2013_p1600173216137"></a>metadata里面不能有value为null的键值对。</p>
    </div></div>
    <p id="evs_04_2013_p862801317585"><a name="evs_04_2013_p862801317585"></a><a name="evs_04_2013_p862801317585"></a>“metadata”字段可选参数如下，创建磁盘时仅支持以下字段。</p>
    <a name="ul103811842102918"></a><a name="ul103811842102918"></a><ul id="ul103811842102918"><li>__system__cmkid<p id="p043285918297"><a name="p043285918297"></a><a name="p043285918297"></a>metadata中的加密cmkid字段,与__system__encrypted配合表示需要加密,cmkid长度固定为36个字节。</p>
    <div class="note" id="note19363152663217"><a name="note19363152663217"></a><a name="note19363152663217"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="evs_04_2013_p093935613512"><a name="evs_04_2013_p093935613512"></a><a name="evs_04_2013_p093935613512"></a>请参考<a href="https://support.huaweicloud.com/api-dew/ListKeys.html" target="_blank" rel="noopener noreferrer">查询密钥列表</a>，通过HTTPS请求获取密钥ID。</p>
    </div></div>
    </li><li>__system__encrypted<p id="p20617937153015"><a name="p20617937153015"></a><a name="p20617937153015"></a>metadata中的表示加密功能的字段,0代表不加密,1代表加密。不指定该字段时,云硬盘的加密属性与数据源保持一致,如果不是从数据源创建的场景,则默认不加密。</p>
    </li><li>full_clone<p id="p11371451153017"><a name="p11371451153017"></a><a name="p11371451153017"></a>从快照创建云硬盘时,如需使用link克隆方式,请指定该字段的值为0。</p>
    </li><li>hw:passthrough<a name="ul475012350321"></a><a name="ul475012350321"></a><ul id="ul475012350321"><li>true表示云硬盘的设备类型为SCSI类型,即允许ECS操作系统直接访问底层存储介质。支持SCSI锁命令。</li><li>false表示云硬盘的设备类型为VBD (虚拟块存储设备 , Virtual Block Device)类型,即为默认类型,VBD只能支持简单的SCSI读写命令。</li><li>该字段不存在时,云硬盘默认为VBD类型。</li></ul>
    </li></ul>
    </td>
    </tr>
...
-   <a name="li16166115891018"></a>OS-SCH-HNT:scheduler\_hints参数说明

    <a name="table19294112711113"></a>
    <table><thead align="left"><tr id="row029492741117"><th class="cellrowborder" valign="top" width="18.42%" id="mcps1.1.5.1.1"><p id="p38283991110"><a name="p38283991110"></a><a name="p38283991110"></a>参数</p>
    </th>
    <th class="cellrowborder" valign="top" width="19.64%" id="mcps1.1.5.1.2"><p id="p982103914111"><a name="p982103914111"></a><a name="p982103914111"></a>参数类型</p>
    </th>
    <th class="cellrowborder" valign="top" width="16%" id="mcps1.1.5.1.3"><p id="p1382193910111"><a name="p1382193910111"></a><a name="p1382193910111"></a>是否必选</p>
    </th>
    <th class="cellrowborder" valign="top" width="45.94%" id="mcps1.1.5.1.4"><p id="p10821939131113"><a name="p10821939131113"></a><a name="p10821939131113"></a>描述</p>
    </th>
    </tr>
    </thead>
    <tbody><tr id="row1329414274119"><td class="cellrowborder" valign="top" width="18.42%" headers="mcps1.1.5.1.1 "><p id="p152946277111"><a name="p152946277111"></a><a name="p152946277111"></a>dedicated_storage_id</p>
    </td>
    <td class="cellrowborder" valign="top" width="19.64%" headers="mcps1.1.5.1.2 "><p id="p329417279113"><a name="p329417279113"></a><a name="p329417279113"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="16%" headers="mcps1.1.5.1.3 "><p id="p6294122711117"><a name="p6294122711117"></a><a name="p6294122711117"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="45.94%" headers="mcps1.1.5.1.4 "><p id="p1629442761117"><a name="p1629442761117"></a><a name="p1629442761117"></a>指定专属存储池ID,表示将云硬盘创建在该ID对应的存储池中。</p>
    </td>
    </tr>
    </tbody>
    </table>
...
-   响应参数
    ...
    <tr id="row17179172632219"><td class="cellrowborder" valign="top" width="20.24%" headers="mcps1.1.4.1.1 "><p id="p1918032613220"><a name="p1918032613220"></a><a name="p1918032613220"></a>volume_ids</p>
    </td>
    <td class="cellrowborder" valign="top" width="21.43%" headers="mcps1.1.4.1.2 "><p id="p8180142611222"><a name="p8180142611222"></a><a name="p8180142611222"></a>Array of strings</p>
    </td>
    <td class="cellrowborder" valign="top" width="58.330000000000005%" headers="mcps1.1.4.1.3 "><p id="p15180182622218"><a name="p15180182622218"></a><a name="p15180182622218"></a>待创建的磁盘ID列表。</p>
    </td>
    </tr>
    </tbody>
    </table>
