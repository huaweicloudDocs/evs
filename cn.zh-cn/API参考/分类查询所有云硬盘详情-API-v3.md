# 分类查询所有云硬盘详情<a name="ZH-CN_TOPIC_0102756196"></a>
...
-   Request filter参数说明
    ...
    <tbody><tr id="zh-cn_topic_0098680634_row58489940152531"><td class="cellrowborder" valign="top" width="16%" headers="mcps1.1.5.1.1 "><p id="zh-cn_topic_0098680634_p49168107152914"><a name="zh-cn_topic_0098680634_p49168107152914"></a><a name="zh-cn_topic_0098680634_p49168107152914"></a>marker</p>
    </td>
...
-   metadata参数说明
    ...
    <tr id="row16478023164611"><td class="cellrowborder" valign="top" width="20.24%" headers="mcps1.1.4.1.1 "><p id="p15479323204615"><a name="p15479323204615"></a><a name="p15479323204615"></a>readonly</p>
    </td>
    <td class="cellrowborder" valign="top" width="22.62%" headers="mcps1.1.4.1.2 "><p id="p134792232467"><a name="p134792232467"></a><a name="p134792232467"></a>string</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><div class="p" id="p3479112318462"><a name="p3479112318462"></a><a name="p3479112318462"></a>是否为只读模式云硬盘。<a name="ul11587123175320"></a><a name="ul11587123175320"></a><ul id="ul11587123175320"><li>True表示云硬盘仅支持可读模式。</li><li>False表示云硬盘支持读写模式。</li></ul>
    </div>
    </td>
    </tr>
    <tr id="row347911235465"><td class="cellrowborder" valign="top" width="20.24%" headers="mcps1.1.4.1.1 "><p id="p18479142364612"><a name="p18479142364612"></a><a name="p18479142364612"></a>attached_mode</p>
    </td>
    <td class="cellrowborder" valign="top" width="22.62%" headers="mcps1.1.4.1.2 "><p id="p1547917231465"><a name="p1547917231465"></a><a name="p1547917231465"></a>string</p>
    </td>
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><div class="p" id="p11479102334617"><a name="p11479102334617"></a><a name="p11479102334617"></a>只有当云硬盘已挂载至云服务器时，才有该字段，表示云硬盘的使用模式。<a name="ul17760125635418"></a><a name="ul17760125635418"></a><ul id="ul17760125635418"><li>ro表示只读模式。</li><li>rw表示读写模式。</li></ul>
    </div>
    </td>
    </tr>
    </tbody>
