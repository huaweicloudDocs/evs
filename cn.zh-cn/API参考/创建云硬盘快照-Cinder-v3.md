...
-   响应参数
    ...
    <td class="cellrowborder" valign="top" width="57.14%" headers="mcps1.1.4.1.3 "><p id="p11154391208"><a name="p11154391208"></a><a name="p11154391208"></a>快照信息，请参见<a href="#evs_04_2093_li52620487104128">•snapshot参数说明</a>。</p>
    </td>
    </tr>
