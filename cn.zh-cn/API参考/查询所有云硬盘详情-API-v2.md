...
-   <a name="evs_04_2010_li29114110314"></a>metadata参数说明
    ...
    <p id="evs_04_2010_evs_04_3004_p121347762"><a name="evs_04_2010_evs_04_3004_p121347762"></a><a name="evs_04_2010_evs_04_3004_p121347762"></a>当该字段有值时，表示该云硬盘的计费类型为包周期计费，否则计费类型为按需计费。</p>
    </td>
    </tr>
    </tbody>
    </table>
...
-   <a name="evs_04_2010_li0419202382514"></a>error参数说明
    ...
    <p id="evs_04_2010_evs_04_2013_p54787218103019"><a name="evs_04_2010_evs_04_2013_p54787218103019"></a><a name="evs_04_2010_evs_04_2013_p54787218103019"></a>错误码和其对应的含义请参考<a href="错误码.md">错误码</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
