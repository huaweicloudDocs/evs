# 查询云硬盘快照的元数据<a name="zh-cn_topic_0058626633"></a>
...
-   响应参数
    ...
    <p id="p2691143564618"><a name="p2691143564618"></a><a name="p2691143564618"></a>如果元数据中包含__system__enableActive字段，则表示该快照为云服务器创建备份时自动生成的快照。</p>
    </td>
    </tr>
